...
{-|
  ...
  ConstLet (ConstSymbol "ANSWERE" Real) (RealVal 420)
-}
constLetInAST (ConstLet sym val) = globalGen sym val -- https://github.com/bscarlet/llvm-general/blob/llvm-3.8/llvm-general-pure/src/LLVM/General/AST/Global.hs#L21
